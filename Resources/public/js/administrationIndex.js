...
(function () {
    ...
    $('#admin-home-content').on('click', '#add-hometab-btn', function () {
        window.Claroline.Modal.displayForm(
            Routing.generate('claro_user_tracking_admin_tab_create_form'),
            openHomeTab,
            function() {}
        );
    });
    ...
    $('#admin-home-content').on('click', '.edit-hometab-btn', function (e) {
        ...
        window.Claroline.Modal.displayForm(
            Routing.generate(
                'claro_user_tracking_admin_tab_edit_form',
                {
                    'homeTab': homeTabId,
    ...
    $('#admin-home-content').on('click', '.delete-hometab-btn', function (e) {
        ...
        window.Claroline.Modal.confirmRequest(
            Routing.generate(
                'claro_user_tracking_admin_tab_delete',
                {'homeTab': homeTabId}
            ),
            removeHomeTab,
            homeTabId,
        ...
        if (this === ui.item.parents('#admin-hometabs-list')[0]) {
            ...
            $.ajax({
                url: Routing.generate(
                    'claro_user_tracking_admin_tab_config_reorder',
                    {
                        'homeTabConfig': hcId,
    ...
    $('#widgets-section').on('click', '#create-widget-instance', function () {
        window.Claroline.Modal.displayForm(
            Routing.generate(
                'claro_user_tracking_admin_widget_instance_create_form',
    ...
    $('#widgets-list-panel').on('click', '.edit-widget-btn', function () {
        ...
        window.Claroline.Modal.displayForm(
            Routing.generate(
                'claro_user_tracking_admin_widget_config_edit_form',
                {
    ...
    $('#widgets-list-panel').on('click', '.edit-widget-content-btn', function () {
        ...
        $.ajax({
            url: Routing.generate(
                'claro_user_tracking_admin_widget_configuration',
    ...
    var openHomeTab = function (homeTabId) {
        window.location = Routing.generate(
            'claro_user_tracking_administration_index',
            {'homeTabId': homeTabId}
        );
    };
